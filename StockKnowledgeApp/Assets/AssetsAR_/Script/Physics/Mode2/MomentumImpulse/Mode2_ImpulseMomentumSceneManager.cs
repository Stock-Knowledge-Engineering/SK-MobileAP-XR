...
{
    public Mode2_ImpulseMomentumQuestionManager questionManager;
    ...
    void Awake()
    {
        ...
        questionManager = this.GetComponent<Mode2_ImpulseMomentumQuestionManager>();
    ...
    void Update()
    {
        GetFirstPosition(); // Update for AR purposes #fixes position glitch or jitter in vuforia
